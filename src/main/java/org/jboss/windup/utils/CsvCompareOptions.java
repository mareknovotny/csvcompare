...
public class CsvCompareOptions
{
    ...
    private static Options getCMdOptions() {
        ...
        options.addOption( Option.builder("o").required(true).longOpt("old-file").build());
        options.addOption( Option.builder("n").required(true).longOpt("new-file").build());
        options.addOption( Option.builder("d").longOpt("csv-delimiter").build());
